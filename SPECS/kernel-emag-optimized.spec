...
%ifarch aarch64
%define all_arch_configs kernel-%{version}-aarch64-emag-optimized*.config
...
Source22: kernel-aarch64-emag-optimized.config
...
BuildKernel() {
    ...
    Config=kernel-%{version}-%{_target_cpu}${Flavour:+-${Flavour}}-emag-optimized.config
